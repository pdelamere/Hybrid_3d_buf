...
maind.o:maind.f global.o dimensions.o inputs.o initial.o misc.o gutsp_dd.o gutsp_buf.o gutsf.o part_init.o grid_interp.o chem_rates.o 
	$(FC) $(FFLAGS) -c maind.f

gutsf.o:gutsf.f global.o boundary.o grid_interp.o
	$(FC) $(FFLAGS) -c gutsf.f

gutsp_dd.o:gutsp_dd.f global.o misc.o boundary.o grid_interp.o
	$(FC) $(FFLAGS) -c gutsp_dd.f

misc.o:misc.f random_utils.o global.o boundary.o
	$(FC) $(FFLAGS) -c misc.f

boundary.o:boundary.f global.o
	$(FC) $(FFLAGS) -c boundary.f

part_init.o:part_init.f global.o dimensions.o misc.o gutsp_dd.o 
	$(FC) $(FFLAGS) -c part_init.f

initial.o:initial.f global.o inputs.o chem_rates.o boundary.o 
	$(FC) $(FFLAGS) -c initial.f

gutsp_buf.o:gutsp_buf.f dimensions.o global.o misc.o part_init.o 
	$(FC) $(FFLAGS) -c gutsp_buf.f

chem_rates.o:chem_rates.f global.o inputs.o gutsp_dd.o grid_interp.o 
...
inputs.o:inputs.f dimensions.o 
	$(FC) $(FFLAGS) -c inputs.f

global.o:global.f inputs.o dimensions.o 
	$(FC) $(FFLAGS) -c global.f

grid_interp.o:grid_interp.f global.o dimensions.o boundary.o 
